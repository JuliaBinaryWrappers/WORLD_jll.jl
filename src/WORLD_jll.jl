...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import WORLD_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("df1608cb-88be-5058-95d4-2cc1fff969de"))
platforms = [Pkg.Artifacts.unpack_platform(e, "WORLD", artifacts_toml) for e in artifacts["WORLD"]]
...
if best_platform === nothing
    @debug("Unable to load WORLD; unsupported platform $(triplet(platform_key_abi()))")
else
